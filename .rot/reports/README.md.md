...
`README.md` · **FRESH** · run 2026-09-02T13:32:35Z · image `python:3.12-slim` · engine docker

| # | line | status | time | detail |
|---|---|---|---|---|
| 1 | 55 | works | 1.0s |  |
| 2 | 62 | skipped |  |  |
| 3 | 69 | output differs | 39.2s | same exit code, different output (nothing documented; informational) |
| 4 | 80 | skipped |  |  |
| 5 | 117 | skipped |  |  |
| 6 | 135 | skipped |  |  |
| 7 | 177 | works | 14.0s |  |
| 8 | 185 | skipped |  |  |
| 9 | 216 | output differs | 18.0s | same exit code, different output (nothing documented; informational) |
