...
9. Use only the synths and samples listed under the collection block below, and use the specific instruments assigned to this bed. Effects as the collection describes.
